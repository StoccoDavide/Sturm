 ...
 *
 * This namespace contains all the classes and functions of the Sturm library
 * for the computation of the Sturm sequences and the greatest common divisor
 * polynomials. Other basic functions to manipulate polynomials and sequences
 * are also included.
 */
namespace Sturm {
   ...
   * STURM_DEFAULT_INTEGER_TYPE. The default value is \c int.
   */
