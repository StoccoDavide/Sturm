function(parse_version_string VERSION_STRING)
  ...
  set(STURM_VERSION ${BASE_VERSION} CACHE INTERNAL "")
  set(STURM_VERSION_PRERELEASE ${PRE_RELEASE} CACHE INTERNAL "")
endfunction()
...
function(get_version_from_git)
  ...
  set(STURM_VERSION "0.0.0" CACHE INTERNAL "")
  set(STURM_VERSION_PRERELEASE "" CACHE INTERNAL "")
endfunction()

function(write_version_file)
  if(NOT STURM_VERSION)
    message(FATAL_ERROR "STURM_VERSION is not set")
  endif()

  set(VERSION_STRING "${STURM_VERSION}")
  if(STURM_VERSION_PRERELEASE)
    set(VERSION_STRING "${VERSION_STRING}-${STURM_VERSION_PRERELEASE}")
  endif()
